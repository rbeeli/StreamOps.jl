...
@testset verbose = true "EWZScore" begin
    ...
    @testset "Edge case: Single value" begin
        ...
        run_simulation!(exe, adapters; start_time=DateTime(2000, 1, 1), end_time=DateTime(2000, 1, 1))
    ...
    @testset "Edge case: Constant values" begin
        ...
        run_simulation!(exe, adapters; start_time=DateTime(2000, 1, 1), end_time=DateTime(2000, 1, length(constant_vals)))
