@testitem "reset!" begin
    op = EWStdDev{Float64,Float64}(alpha=0.9, corrected=false)
...
@testitem "alpha=0.9 corrected=false" begin
    ...
    avg = op!(g, :avg, EWStdDev{Float64,Float64}(alpha=0.9, corrected=false))
...
@testitem "alpha=0.9 corrected=true" begin
    ...
    values = source!(g, :values, HistoricIterable(Float64, values_data))
    avg = op!(g, :avg, EWStdDev{Float64,Float64}(alpha=0.9, corrected=true))
    output = sink!(g, :output, Buffer{Float64}())
