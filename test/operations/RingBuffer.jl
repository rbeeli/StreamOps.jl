...
@testitem "RingBuffer{Int}(4) (same as inputs)" begin
    using Dates
...
@testitem "RingBuffer{Int}(10) (larger than inputs)" begin
    using Dates
...
@testitem "RingBuffer{Int}(5, min_count=3)" begin
    using Dates
...
@testitem "RingBuffer{Float64}(5) w/ flush" begin
    using Dates
